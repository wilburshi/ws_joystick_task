...
#define ENABLE_PIN 8 // for motor, not used for the joystick setting
#define DIRECTION_PIN 9 // for motor, not used for the joystick setting
#define PWM_PIN 10 // for motor, not used for the joystick setting
#define FEEDBACK_PIN 11 // for motor, not used for the joystick setting
#define analogResolution 16
#define STRAINGAUGE_PIN 14
#define POT_PIN 22

// for motor, not used for the joystick setting
